...
- **Meditation Timer**: A customizable unguided meditation timer with ambient sounds
- **Daily Sadhana Tracking**: Habit tracking for meditation, exercise, cold shower, and early wakeup with streaks and analytics
- **Content Directory**: A searchable library of bhajans, satsangs, guided meditations, and spiritual talks
- **Live Events**: Registration and participation in live meditation sessions, workshops, and satsangs
- **Daily Quotes**: Curated spiritual quotes refreshed daily
- **Premium Subscription**: Enhanced access to the full content library, advanced features, and an ad-free experience
...
You must be at least 13 years of age to create an account and use the App. If you are between 13 and 18 years of age, you must have the consent of a parent or legal guardian to use the App.
...
Each individual may maintain only one active account. Creating multiple accounts to circumvent restrictions, abuse free tier limits, or manipulate streak data is prohibited and may result in account termination.
...
- Full ambient sound collection for the meditation timer
...
|------|-------|--------------|
| **Monthly** | INR 199 per month | Billed monthly |
| **Annual** | INR 1,499 per year | Billed annually (equivalent to ~INR 125/month, 37% savings) |

All prices are in Indian Rupees (INR) and inclusive of applicable taxes.

### 3.4 Payment Processing

Payments are processed securely through Razorpay, a PCI DSS Level 1 compliant payment gateway. We accept:
...
- **Monthly Plan**: Automatically renews every 30 days from the date of purchase
- **Annual Plan**: Automatically renews every 365 days from the date of purchase

You will be charged the applicable subscription fee at the beginning of each renewal period unless you cancel before the renewal date.
...
- Your meditation data, course progress, and other personal data are retained
...
- Existing subscribers will be notified at least 30 days before the change takes effect
...
- Download content for offline use (Premium subscribers only), strictly for personal use on your registered devices

### 4.3 Restrictions

You may not:
- Copy, reproduce, distribute, or publicly display any content from the App
- Record, screen-capture, or create derivative works from meditation sessions, courses, or other audio/video content
- Remove, alter, or obscure any copyright, trademark, or proprietary notices
- Use content from the App for commercial purposes
- Share your account credentials to provide access to others
- Reverse engineer, decompile, or disassemble the App software
- Use automated tools (bots, scrapers) to access or extract content from the App

### 4.4 User-Generated Content

Currently, the App does not support public user-generated content (posts, reviews visible to others). Your personal data (meditation logs, habit data, bookmarks) is private to your account. If we introduce user-generated content features in the future, these Terms will be updated accordingly.
...
1. **Misuse the Service**: Attempt to gain unauthorized access to the App, its servers, or any connected systems
2. **Circumvent Security**: Bypass or attempt to bypass any security measures, authentication systems, or content restrictions
3. **Abuse the Platform**: Use the App to transmit malware, viruses, or any harmful code
4. **Manipulate Data**: Falsify meditation data, streak records, or other tracked metrics
5. **Harass Others**: Use any communication feature to harass, threaten, or intimidate any person
6. **Impersonate**: Impersonate any person or entity, or falsely represent your affiliation with any person or entity
7. **Spam**: Use the App to send unsolicited communications
8. **Violate Laws**: Use the App in any manner that violates applicable local, state, national, or international law
9. **Exploit Vulnerabilities**: Exploit any bugs, glitches, or vulnerabilities in the App for personal gain or to disrupt the service
...
If you have a medical condition, consult a qualified healthcare provider before beginning any meditation, breathing, or exercise practice.

### 6.2 Service "As Is"

THE APP AND ALL CONTENT ARE PROVIDED "AS IS" AND "AS AVAILABLE" WITHOUT WARRANTIES OF ANY KIND, EITHER EXPRESS OR IMPLIED, INCLUDING BUT NOT LIMITED TO IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, AND NON-INFRINGEMENT.
...
- Any damages arising from content or services provided through the App

OUR TOTAL LIABILITY FOR ANY CLAIM ARISING FROM OR RELATED TO THESE TERMS OR THE APP SHALL NOT EXCEED THE AMOUNT YOU PAID TO US IN THE 12 MONTHS PRECEDING THE CLAIM, OR INR 1,499, WHICHEVER IS GREATER.
...
- You engage in prohibited conduct as described in Section 5
...
- Your personal data will be handled in accordance with our Privacy Policy (deleted within 30 days)
- If you have an active subscription, no further charges will occur; access continues until the current billing period ends
- Provisions of these Terms that by their nature should survive termination shall survive (including Sections 4, 6, 7, 8, and 11)
...
If informal resolution fails, any dispute arising from or relating to these Terms shall be resolved through binding arbitration in accordance with the Arbitration and Conciliation Act, 1996 (India). The arbitration shall:
...
- Small claims within the jurisdiction of applicable small claims courts

---

## 11. Governing Law and Jurisdiction

These Terms shall be governed by and construed in accordance with the laws of India, without regard to conflict of law principles. Subject to the arbitration provision above, any legal proceedings shall be brought exclusively in the courts located in Pune, Maharashtra, India.
...
We shall not be liable for any failure or delay in performing our obligations due to circumstances beyond our reasonable control, including but not limited to natural disasters, war, terrorism, pandemics, government actions, internet outages, or third-party service failures.
...
- We will notify you through an in-app notification or email at least 15 days before the changes take effect
